...
const About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-fgvcgy_START -->${$$result.title = `<title>About Me</title>`, ""}<!-- HEAD_svelte-fgvcgy_END -->`, ""} <main class="flex flex-col flex-1 p-4"><section id="about" class="py-20 pt-10 lg:pt-16 lg:py-32 flex flex-col gap-16 sm:gap-20 md:gap-24 relative" data-svelte-h="svelte-1lrfure"><div class="flex flex-col gap-2 text-center relative before:absolute before:top-0 before:left-0 before:w-2/3 before:h-1.5 before:bg-violet-700 after:absolute after:bottom-0 after:right-0 after:w-2/3 after:h-1.5 after:bg-violet-700 py-4"><h6 class="text-large sm:text-xl md:text-2xl">Hello! Let&#39;s learn</h6> <h3 class="font-semibold text-3xl sm:text-4xl md:text-5xl"><span class="poppins text-violet-400">About</span> me.</h3></div>  <ul class="flex flex-wrap justify-center gap-2 text-sm font-medium text-center text-gray-500 dark:text-gray-400 svelte-9onc2m"><li class="me-2"><a href="#myEdu" class="inline-block px-3 py-2 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white svelte-9onc2m">Education</a></li> <li class="me-2"><a href="#myAchievement" class="inline-block px-3 py-2 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white svelte-9onc2m">Certificates</a></li> <li class="me-2"><a href="#mySkills" class="inline-block px-3 py-2 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white svelte-9onc2m">Skills</a></li> <li class="me-2"><a href="#myHobbies" class="inline-block px-3 py-2 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white svelte-9onc2m">Likes</a></li></ul> <section id="myProfile" class="grid grid-cols-1 lg:grid-cols-2 lg:gap-2 gap-10"> <div class="relative shadow-2xl grid place-items-center"><img id="aboutProfile"${add_attribute("src", `${base}/images/profile3.jpeg`, 0)} alt="Chan Xue Li" class="object-cover z-[2] max-h-[70vh] rounded-lg overflow-hidden svelte-9onc2m"></div>  <div id="aboutContent" class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10 svelte-9onc2m"><h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">About Me</h2> <p class="text-base sm:text-lg md:text-xl" style="text-align: justify;">My journey with IT began in primary school through the ICT Club CCA,
          ...
          haha).</p>  <div class="flex items-center gap-4"><a${add_attribute("href", `${base}/pdf/ChanXueLi_resume.pdf`, 0)} download class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded transition duration-300 focus:outline-none focus:ring focus:ring-blue-300">Download Resume</a> <a href="https://www.linkedin.com/in/xue-li" target="_blank" rel="noopener noreferrer"><img src="https://www.svgrepo.com/show/28145/linkedin.svg" width="30" height="30" alt="LinkedIn"></a> <a href="mailto:cxuelisit@gmail.com" target="_blank" rel="noopener noreferrer"><img${add_attribute("src", `${base}/icons/gmail.svg`, 0)} width="30" height="30" alt="Gmail"></a></div></div></section></section>   <section id="myEdu" class="py-20 pt-10 lg:pt-16 lg:py-32 flex flex-col gap-16 sm:gap-20 md:gap-24 relative"><div class="flex flex-col gap-2 text-center relative before:absolute before:top-0 before:left-0 before:w-2/3 before:h-1.5 before:bg-violet-700 after:absolute after:bottom-0 after:right-0 after:w-2/3 after:h-1.5 after:bg-violet-700 py-4" data-svelte-h="svelte-l23kw5"><h3 class="font-semibold text-3xl sm:text-4xl md:text-5xl"><h6 class="text-large sm:text-xl md:text-2xl"></h6> <h3 class="font-semibold text-3xl sm:text-4xl md:text-5xl">Education</h3></h3></div> <div class="grid grid-cols-1 lg:grid-cols-3 gap-20 lg:gap-25">${validate_component(Step, "Step").$$render($$result, { step: steps[0] }, {}, {
    default: () => {
    ...
    default: () => {
      return `<p data-svelte-h="svelte-w8j6ji"><b style="color: var(--xblue);">Apr 2024</b></p> <div class="internContent" data-svelte-h="svelte-sjcdcs"><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" style="width: fit-content; margin-right: auto; margin-left: auto;"><a href="https://www.codecademy.com/users/chanxueli/achievements" target="_blank" rel="noopener noreferrer">Codeacademy Profile</a></button></div>`;
    }
  ...
  })}</div></section>  <section id="mySkills" data-svelte-h="svelte-3r4akb"><br> <div class="flex flex-col gap-2 text-center relative before:absolute before:top-0 before:left-0 before:w-2/3 before:h-1.5 before:bg-violet-700 after:absolute after:bottom-0 after:right-0 after:w-2/3 after:h-1.5 after:bg-violet-700 py-4"><h6 class="text-large sm:text-xl md:text-2xl"></h6> <h3 class="font-semibold text-3xl sm:text-4xl md:text-5xl">Skills</h3></div> <br> <div class="grid grid-cols-1 md:grid-cols-6 gap-4"><div class="grid-item"><img id="skillIcon"${add_attribute("src", `${base}/skills/html.png`, 0)} alt="HTML" class="svelte-9onc2m"></div> <div class="grid-item"><img id="skillIcon"${add_attribute("src", `${base}/skills/css.png`, 0)} alt="CSS" class="svelte-9onc2m"></div> <div class="grid-item"><img id="skillIcon"${add_attribute("src", `${base}/skills/javascript.png`, 0)} alt="Javascript" class="svelte-9onc2m"></div> <div class="grid-item"><img id="skillIcon"${add_attribute("src", `${base}/skills/jquery.png`, 0)} alt="jQuery" class="svelte-9onc2m"></div> <div class="grid-item"><img id="skillIcon"${add_attribute("src", `${base}/skills/svelte.png`, 0)} alt="svelte" class="svelte-9onc2m"></div> <div class="grid-item"><img id="skillIcon"${add_attribute("src", `${base}/skills/python.png`, 0)} alt="python" class="svelte-9onc2m"></div> <div class="grid-item"><img id="skillIcon"${add_attribute("src", `${base}/skills/illustrator.png`, 0)} alt="illustrator" class="svelte-9onc2m"></div> <div class="grid-item"><img id="skillIcon"${add_attribute("src", `${base}/skills/photoshop.png`, 0)} alt="photoshop" class="svelte-9onc2m"></div> <div class="grid-item"><img id="skillIcon"${add_attribute("src", `${base}/skills/xd.png`, 0)} alt="xd" class="svelte-9onc2m"></div> <div class="grid-item"><img id="skillIcon"${add_attribute("src", `${base}/skills/figma.png`, 0)} alt="figma" class="svelte-9onc2m"></div> <div class="grid-item"><img id="skillIcon"${add_attribute("src", `${base}/skills/sql.png`, 0)} alt="sql" class="svelte-9onc2m"></div> <div class="grid-item"><img id="skillIcon"${add_attribute("src", `${base}/skills/react.png`, 0)} alt="react" class="svelte-9onc2m"></div> <div class="grid-item"><img id="skillIcon"${add_attribute("src", `${base}/skills/premire.png`, 0)} alt="premiere" class="svelte-9onc2m"></div></div></section>  <section id="myHobbies" data-svelte-h="svelte-yqz1w0"><div class="flex flex-col gap-2 text-center relative before:absolute before:top-0 before:left-0 before:w-2/3 before:h-1.5 before:bg-violet-700 after:absolute after:bottom-0 after:right-0 after:w-2/3 after:h-1.5 after:bg-violet-700 py-4"><h6 class="text-large sm:text-xl md:text-2xl"></h6> <h3 class="font-semibold text-3xl sm:text-4xl md:text-5xl">Likes</h3></div> <br> <div class="grid grid-cols-1 md:grid-cols-5 gap-4"><div class="grid-item"><img${add_attribute("src", `${base}/likes/like6.jpeg`, 0)} alt="Kpop concert"></div> <div class="grid-item"><img${add_attribute("src", `${base}/likes/like1.jpeg`, 0)} alt="Kpop concert"></div> <div class="grid-item"><img${add_attribute("src", `${base}/likes/like2.jpeg`, 0)} alt="Kpop concert"></div> <div class="grid-item"><img${add_attribute("src", `${base}/likes/like3.jpeg`, 0)} alt="Drawing"></div> <div class="grid-item"><img${add_attribute("src", `${base}/likes/like4.jpeg`, 0)} alt="Drawing"></div> <div class="grid-item"><img${add_attribute("src", `${base}/likes/like5.jpeg`, 0)} alt="Badminton"></div></div></section> </main>`;
});
