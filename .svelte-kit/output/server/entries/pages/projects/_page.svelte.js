...
const css = {
  code: '.button-container.svelte-vddk6g.svelte-vddk6g{display:flex;flex-direction:column;align-items:center;gap:10px}.button.svelte-vddk6g.svelte-vddk6g{margin-bottom:10px;background-color:#4285f4;color:white;font-weight:bold;padding:10px 20px;border:none;border-radius:5px}@media(min-width: 768px){.button-container.svelte-vddk6g.svelte-vddk6g{flex-direction:row;justify-content:center}.button.svelte-vddk6g.svelte-vddk6g{margin-bottom:0;margin-right:10px}}.project-thumbnail.svelte-vddk6g.svelte-vddk6g{display:flex;align-items:center;justify-content:center;margin-bottom:20px;width:calc(70%);margin-right:auto;margin-left:auto;max-width:800px;padding:20px;border-radius:10px;box-shadow:0 4px 6px rgba(0, 0, 0, 0.1)}.project-thumbnail.svelte-vddk6g img.svelte-vddk6g{width:200px;margin-right:40px}@media screen and (max-width: 768px){.project-thumbnail.svelte-vddk6g.svelte-vddk6g{flex-direction:column;align-items:center;width:calc(100% - 40px)}.project-thumbnail.svelte-vddk6g img.svelte-vddk6g{margin-right:0;margin-bottom:10px}}#feature-head.svelte-vddk6g.svelte-vddk6g{text-align:left;padding-left:50px;margin-bottom:5px}.circle-bullet-list.svelte-vddk6g.svelte-vddk6g{list-style-type:none;padding-left:50px;text-align:left}.circle-bullet-list.svelte-vddk6g li.svelte-vddk6g::before{content:"\\2022";color:white;font-weight:bold;display:inline-block;width:1em;margin-left:-1em}@media screen and (max-width: 768px){#feature-head.svelte-vddk6g.svelte-vddk6g{padding-left:0px}.circle-bullet-list.svelte-vddk6g.svelte-vddk6g{padding-left:0px}}.grid-item.svelte-vddk6g.svelte-vddk6g{width:100%;position:relative;display:flex;flex-direction:column;justify-content:center;align-items:center;overflow:hidden;border-radius:8px}.grid-item.svelte-vddk6g img.svelte-vddk6g{width:100%;height:auto;display:block;border-radius:8px}@media screen and (max-width: 768px){.mobile-responsive-iframe.svelte-vddk6g.svelte-vddk6g{width:100%;height:0;position:relative;padding-bottom:75%}.mobile-responsive-iframe.svelte-vddk6g iframe.svelte-vddk6g{position:absolute;top:0;left:0;width:100%;height:100%}}',
  map: null
};
  ...
  return `${$$result.head += `<!-- HEAD_svelte-1en3a0b_START -->${$$result.title = `<title>Projects</title>`, ""}<!-- HEAD_svelte-1en3a0b_END -->`, ""} <main class="flex flex-col flex-1 p-4"> <section class="py-20 pt-10 lg:pt-16 lg:py-32 flex flex-col gap-16 sm:gap-20 md:gap-24 relative" id="projects"> <div class="flex flex-col gap-2 text-center relative before:absolute before:top-0 before:left-0 before:w-2/3 before:h-1.5 before:bg-violet-700 after:absolute after:bottom-0 after:right-0 after:w-2/3 after:h-1.5 after:bg-violet-700 py-4" data-svelte-h="svelte-1xiutnn"><h6 class="text-large sm:text-xl md:text-2xl">By Me</h6> <h3 class="font-semibold text-3xl sm:text-4xl md:text-5xl"><span class="poppins text-violet-400">Personal</span> Projects</h3></div> <div class="grid grid-cols-1 lg:grid-cols-1 gap-20 lg:gap-25">${validate_component(Step, "Step").$$render($$result, { step: steps[0] }, {}, {
    default: () => {
      return `<p data-svelte-h="svelte-5foxnu">Took part in this bootcamp to enhance my frontend development skills.
          My group achieved <b style="color: var(--xpink);">2nd best user experience</b>.</p>   <div class="mobile-responsive-iframe svelte-vddk6g" data-svelte-h="svelte-wyrjb6"><iframe width="560" height="315" src="https://www.youtube.com/embed/FkEoiOE0eqQ?si=dfsev3Le7rOfpWDA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="margin-right:auto; margin-left:auto;" class="svelte-vddk6g"></iframe></div> <div class="button-container svelte-vddk6g">${validate_component(PDFViewer, "PDFViewer").$$render(
        $$result,
        {
    ...
    default: () => {
      return `<p data-svelte-h="svelte-1vtk3zv">This project is part of <b style="color:var(--xblue);">SIT-UoG Overseas Immersion Program in University of Glasgow</b></p> <div class="button-container svelte-vddk6g" data-svelte-h="svelte-609mki"><button class="button svelte-vddk6g"><a href="https://whathellahor.github.io/3003-alexanderthomson/" target="_blank" rel="noopener noreferrer">Project Link</a></button>  <div class="mobile-responsive-iframe svelte-vddk6g"><iframe width="560" height="315" src="https://www.youtube.com/embed/Vfy14ZsiwgU?si=xCQWSQdhvZEj0Tod" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="margin-right:auto; margin-left: auto;" class="svelte-vddk6g"></iframe></div></div> <p data-svelte-h="svelte-ishv6w">Developed a <b style="color:var(--xpeach);">virtual exhibition</b> for
    ...
    default: () => {
      return `<p data-svelte-h="svelte-6nhmmr">Selected by SP to go on a Learning Xchange program to Isabella,
          ...
          develop a solution for the locals tomato jam business.</p> <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" style="width: fit-content; margin-right: auto; margin-left: auto;" data-svelte-h="svelte-j1vl0b"><a href="https://docs.google.com/presentation/d/122nz4PTKasPWXog0QvH8id-Sz3XxaX4xQ8iDLcMOg40/edit#slide=id.g56036d978a_0_70" target="_blank" rel="noopener noreferrer">Project Presentation</a></button> <p data-svelte-h="svelte-a1bcqh"><b style="color:var(--xpurple);">Skills:</b> Design Thinking · Interpersonal
          Skills · Teamwork</p>  <div class="grid grid-cols-1 md:grid-cols-3 gap-4" data-svelte-h="svelte-4pu5oq"><div class="grid-item svelte-vddk6g"><img${add_attribute("src", `${base}/LeXImg/tomato1.jpeg`, 0)} alt="Tomato 1" class="svelte-vddk6g"><br> <p>Tomato Family Team</p></div> <div class="grid-item svelte-vddk6g"><img${add_attribute("src", `${base}/LeXImg/tomato2.jpeg`, 0)} alt="Tomato 2" class="svelte-vddk6g"><br> <p>Interview with Village Chief</p></div> <div class="grid-item svelte-vddk6g"><img${add_attribute("src", `${base}/LeXImg/tomato3.jpeg`, 0)} alt="Tomato 3" class="svelte-vddk6g"><br> <p>Showcase</p></div> <div class="grid-item svelte-vddk6g"><img${add_attribute("src", `${base}/LeXImg/tomato4.jpeg`, 0)} alt="Tomato 4" class="svelte-vddk6g"><br> <p>Tomato Jam Making Process</p></div> <div class="grid-item svelte-vddk6g"><img${add_attribute("src", `${base}/LeXImg/tomato5.jpeg`, 0)} alt="Tomato 5" class="svelte-vddk6g"><br> <p>Tomato Jam Machine Prototype</p></div></div>`;
    }
    ...
    default: () => {
      return `<p data-svelte-h="svelte-1pfdhyr">Some infographic works done using <img${add_attribute("src", `${base}/icons/illustrator.png`, 0)} alt="Illustrator Icon" style="width: 20px; height: auto; margin-right: 5px; display: inline;"> Adobe Illustrator for my modules.</p> <p data-svelte-h="svelte-1dpvmzu"><b style="color:var(--xpurple);">Skills:</b> Adobe Illustrator · Adobe
          XD · UI · UX · Design Thinking · Team Collaboration</p> <div class="project-thumbnail svelte-vddk6g"> <img${add_attribute("src", `${base}/polyImg/pdf1.png`, 0)} alt="Project Thumbnail" class="svelte-vddk6g"> <div class="project-details"><p data-svelte-h="svelte-bc32ci">Infographic activity to familarise with AI tools</p> <br>  ${validate_component(PDFViewer, "PDFViewer").$$render(
        $$result,
        {
        ...
        {},
        {}
      )}</div></div> <div class="project-thumbnail svelte-vddk6g"> <img${add_attribute("src", `${base}/polyImg/pdf2.png`, 0)} alt="Project Thumbnail" class="svelte-vddk6g"> <div class="project-details"><p data-svelte-h="svelte-ooop2n">Infographic proposal on mental health (stress) among polytechnic
        ...
        {},
        {}
      )}</div></div> <div class="project-thumbnail svelte-vddk6g"> <img${add_attribute("src", `${base}/polyImg/pdf3.png`, 0)} alt="Project Thumbnail" class="svelte-vddk6g"> <div class="project-details"><p data-svelte-h="svelte-1tknlfo">&#39;Feast&#39; mobile application design. Feast is a fictional restaurant
              ...
              (not included here).</p> <br> <p id="feature-head" class="svelte-vddk6g" data-svelte-h="svelte-1h1y0dv"><b>Features:</b></p> <ul class="circle-bullet-list svelte-vddk6g" data-svelte-h="svelte-f58cbb"><li class="svelte-vddk6g">Log in</li> <li class="svelte-vddk6g">Main page</li> <li class="svelte-vddk6g">Filters (location)</li> <li class="svelte-vddk6g">For you recommended restaurants</li> <li class="svelte-vddk6g">&#39;Feast&#39; featured restaurants</li> <li class="svelte-vddk6g">Search page (Search bar, Filters: Meal type, No. of guests,
                Price, Ammenties, Cuisines)</li> <li class="svelte-vddk6g">Restaurant Page (Details, Croud watch, Menu, Reserve buttons)</li> <li class="svelte-vddk6g">Menu: Translate, View reviews, Dietary and spicy indications</li> <li class="svelte-vddk6g">Reviews page</li></ul> <br>  ${validate_component(PDFViewer, "PDFViewer").$$render(
        $$result,
        {
        ...
        {},
        {}
      )}</div></div> <div class="project-thumbnail svelte-vddk6g"> <img${add_attribute("src", `${base}/polyImg/pdf4.png`, 0)} alt="Project Thumbnail" style="width: 300px;" class="svelte-vddk6g"> <div class="project-details"><p data-svelte-h="svelte-vbk59g">Infographic resume project (k-pop, vending machine, youtube,
        ...
        {},
        {}
      )}</div></div> <div class="project-thumbnail svelte-vddk6g"> <img${add_attribute("src", `${base}/polyImg/pdf5.png`, 0)} alt="Project Thumbnail" class="svelte-vddk6g"> <div class="project-details"><p data-svelte-h="svelte-y7kt0v">Infographic resume design journey</p> <br>  ${validate_component(PDFViewer, "PDFViewer").$$render(
        $$result,
        {
        ...
        {},
        {}
      )}</div></div> <div class="project-thumbnail svelte-vddk6g"> <img${add_attribute("src", `${base}/polyImg/pdf6.png`, 0)} alt="Project Thumbnail" class="svelte-vddk6g"> <div class="project-details"><p data-svelte-h="svelte-1nfucmb">Potrait</p> <br>  ${validate_component(PDFViewer, "PDFViewer").$$render(
        $$result,
        {
    ...
    default: () => {
      return `<p data-svelte-h="svelte-1vjkxy6">First digital marketing project in Year 1. Helped a small beauty salon
          ...
          Skill · Video Editing · Adobe Photoshop</p>  <div class="grid grid-cols-1 md:grid-cols-3 gap-4" data-svelte-h="svelte-1mgkpyl"><div class="grid-item svelte-vddk6g"><img${add_attribute("src", `${base}/polyImg/DBIT1A02a, 1816655 Chan Xue Li - Brochure.jpg`, 0)} alt="La Reine 1" class="svelte-vddk6g"><br> <p>Proposed Brochure Design (Front)<br>(colour and font not updated
              as outdated)</p></div> <div class="grid-item svelte-vddk6g"><img${add_attribute("src", `${base}/polyImg/DBIT1A02a, 1816655 Chan Xue Li - Brochure (2).jpg`, 0)} alt="La Reine 2" class="svelte-vddk6g"><br> <p>Proposed Brochure Design (Back)<br>(colour and font not updated
              as outdated)</p></div> <div class="grid-item svelte-vddk6g"><img${add_attribute("src", `${base}/polyImg/DBIT1A02a, 1816655 Chan Xue Li - Flyer.jpg`, 0)} alt="La Reine 3" class="svelte-vddk6g"><br> <p>Proposed Anniversary Promotion Poster<br>(colour and font not
              updated as outdated)</p></div> <div class="grid-item svelte-vddk6g"><img${add_attribute("src", `${base}/polyImg/ladigi1.png`, 0)} alt="La Reine 4" class="svelte-vddk6g"><br> <p>Giveaway on Facebook</p></div> <div class="grid-item svelte-vddk6g"><img${add_attribute("src", `${base}/polyImg/ladigi2.png`, 0)} alt="La Reine 5" class="svelte-vddk6g"><br> <p>One of the Question of Day on Facebook</p></div> <div class="grid-item svelte-vddk6g"><img${add_attribute("src", `${base}/polyImg/ladigi3.png`, 0)} alt="La Reine 6" class="svelte-vddk6g"><br> <p>One of the Question of Day on Facebook</p></div></div>`;
    }
  })}</div></section> </main>`;
});
